export const DEMO_EMAILS = [
  ...
  {
    id: 2,
    from: "hr@localstartup.com",
    subject: "Web Developer Internship",
    preview: "Join our team this summer...",
    time: "9:15 AM",
    body: "We are looking for a Senior Web intern. Requirements: Ruby on Rails, C++. CGPA: 3.9+. Deadline: May 20, 2026.",
    isRead: false,
  },
  {
    id: 3,
    from: "grants@globalfoundation.org",
    subject: "Scholarship Opportunity (Expired)",
    preview: "The 2024 grant cycle is now closed...",
    time: "Yesterday",
    body: "Thank you for your interest. The deadline for the Global Scholar Grant was March 15, 2024. Please check back next year.",
    isRead: true,
  },
  {
    id: 4,
    from: "talent@google.com",
    subject: "Google Step Internship 2026",
    preview: "Based on your skills in Python and React...",
    time: "2 days ago",
    body: "Dear Student, the Google Step Internship is a paid program for students with 3.0+ CGPA and skills in Python or React. We provide a monthly stipend and housing. Deadline: June 30, 2026.",
    isRead: false,
  },
  {
    id: 5,
